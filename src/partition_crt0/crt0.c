 ...
 *
 * @warning MUST REMAIN SYNCHRONIZED with fae format's fae_utils/build_fae.py definition
 */
#define CRT0_MAGIC_NUMBER_AND_VERSION ((uint32_t)0xFACADE12)
...
/**
 * @pre ctx is a pointer to a memory region containing an
